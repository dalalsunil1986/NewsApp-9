...
public class us_news extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<News>> {
    public static final String DATA_URL="https://newsapi.org/v2/everything?domains=wsj.com,nytimes.com&apiKey=efcb4792515b458290b7ccf3a558633b&language=en";
...
//        task.execute();
        ListView listView = (ListView) findViewById(R.id.list_us);
...
//    }
    ...
    {
        newsLoader nLoader=new newsLoader(us_news.this);
        return nLoader;
    }
    @Override
